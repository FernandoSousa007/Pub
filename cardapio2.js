let p1=[0,"Mussarela",29.99,0]
let p2=[0,"Portuguesa",55.99,0]
let p3=[0,"Frango",39.99,0]
let p4=[0,"Pepperoni",25.99,0]
let p5=[0,"Calabresa",29.99,0]
let p6=[0,"Brigadeiro",39.99,0]
