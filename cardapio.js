let p1=[0,"X-salada",15.99,0]
let p2=[0,"X-EGG",15.99,0]
let p3=[0,"X-Bacon",19.99,0]
let p4=[0,"X-Tudo",25.99,0]
let p5=[0,"X-Picanha",29.99,0]
let p6=[0,"Barata Frita",9.99,0]
let p7=[0,"Suco Natural",7.99,0]
let p8=[0,"Água 500ml",4.99,0]
let p9=[0,"Coca Cola",7.99,0]
let p10=[0,"Guarana",7.99,0]
